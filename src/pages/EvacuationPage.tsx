...
const evacuationRoutes = [
  ...
  },
  {
    ...
    time: 'Blocked',
    distance: '0.8 km',
    points: [dangerZone.center, [-6.195, 106.835], [-6.190, 106.825]] as [number, number][],
  },
];
          ...
          {evacuationRoutes.map(route => (
            <button
              ...
              className={`w-full rounded-xl border p-3 text-left transition-colors ${
                selectedRoute === route.id ? 'border-primary bg-primary/5' : 'border-border bg-secondary'
              }`}
            >
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full" style={{ background: routeColors[route.safety] }} />
